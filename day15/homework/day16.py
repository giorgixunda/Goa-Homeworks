# #. What is the function used to display text in Python?
...
# True and False in Python is False.
...
# The "else" statement in Python "if-else" construct is used to specify the code to execute when the condition in the "if" statement is false.
...
#you can use slicing: my_list[2:6]
